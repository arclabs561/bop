...
from bop.constraints import PYSAT_AVAILABLE, create_default_constraints, ConstraintSolver
...
def test_integration_points_verification():
    ...
    # Check 1: Imports
    from bop.constraints import ConstraintSolver, ToolConstraint, create_default_constraints
    from bop.orchestrator import StructuredOrchestrator, CONSTRAINTS_AVAILABLE
