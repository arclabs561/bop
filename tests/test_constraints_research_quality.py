...
async def test_constraints_build_coherent_cliques():
    ...
    initial_cliques = len(orchestrator.topology.cliques)
    ...
    final_cliques = len(orchestrator.topology.cliques)
...
async def test_constraints_improve_fisher_information():
    ...
    initial_fisher = orchestrator.topology.compute_fisher_information_estimate()
...
async def test_constraints_integrate_with_attractor_basins():
    ...
    initial_basins = len(orchestrator.topology.get_attractor_basins())
